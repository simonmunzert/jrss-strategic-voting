...
for (i in 1:N){
	shift.cola.votes[,i] <- b.incent.cola[1:numsim]*incent.cola[i]*spdf.england$totvt97[i] - b.incent.laco[1:numsim]*incent.laco[i]*spdf.england$totvt97[i]
	shift.coli.votes[,i] <- b.incent.coli[1:numsim]*incent.coli[i]*spdf.england$totvt97[i] - b.incent.lico[1:numsim]*incent.lico[i]*spdf.england$totvt97[i]
	shift.lali.votes[,i] <- b.incent.lali[1:numsim]*incent.lali[i]*spdf.england$totvt97[i] - b.incent.lila[1:numsim]*incent.lila[i]*spdf.england$totvt97[i]
}
...
voteshare97.conser.nostrategic <-  matrix(NA,numsim,528)
voteshare97.labour.nostrategic <-  matrix(NA,numsim,528)
voteshare97.libdem.nostrategic <-  matrix(NA,numsim,528)
voteshare97.other.nostrategic <-   matrix(NA,numsim,528)
for (i in 1:N){
voteshare97.conser.nostrategic[,i] <- voteshare97.conser[i] - shift.conser[,i]
voteshare97.labour.nostrategic[,i] <- voteshare97.labour[i] - shift.labour[,i]
voteshare97.libdem.nostrategic[,i] <- voteshare97.libdem[i] - shift.libdem[,i]
voteshare97.other.nostrategic[,i] <- 1 - (voteshare97.conser.nostrategic[,i] + voteshare97.labour.nostrategic[,i] + voteshare97.libdem.nostrategic[,i])
}

# winners under non-strategic voting
winner97.nostrategic <-   matrix(NA,numsim,528)
for (i in 1:N){
winner97.nostrategic[,i] <-
 ifelse((voteshare97.conser.nostrategic[,i] > voteshare97.labour.nostrategic[,i]) & (voteshare97.conser.nostrategic[,i] > voteshare97.libdem.nostrategic[,i]) & (voteshare97.conser.nostrategic[,i] > voteshare97.other.nostrategic[,i]), 1,
	ifelse((voteshare97.labour.nostrategic[,i] > voteshare97.conser.nostrategic[,i]) & (voteshare97.labour.nostrategic[,i] > voteshare97.libdem.nostrategic[,i]) & (voteshare97.labour.nostrategic[,i] > voteshare97.other.nostrategic[,i]), 2, 
		ifelse((voteshare97.libdem.nostrategic[,i] > voteshare97.conser.nostrategic[,i]) & (voteshare97.libdem.nostrategic[,i] > voteshare97.labour.nostrategic[,i]) & (voteshare97.libdem.nostrategic[,i] > voteshare97.other.nostrategic[,i]), 3, 6)))
}

# seconds under non-strategic voting
second97.nostrategic <-   matrix(NA,numsim,528)
for (i in 1:N){
second97.nostrategic[,i] <-
 ifelse(
	((voteshare97.conser.nostrategic[,i] < voteshare97.labour.nostrategic[,i]) & (voteshare97.conser.nostrategic[,i] > voteshare97.libdem.nostrategic[,i]) & (voteshare97.conser.nostrategic[,i] > voteshare97.other.nostrategic[,i])) |  # labour, conser, libdem, other or labour, conser, other, libdem
	((voteshare97.conser.nostrategic[,i] > voteshare97.labour.nostrategic[,i]) & (voteshare97.conser.nostrategic[,i] < voteshare97.libdem.nostrategic[,i]) & (voteshare97.conser.nostrategic[,i] > voteshare97.other.nostrategic[,i])) |  # libdem, conser, labour, other or libdem, conser, other, labour
	((voteshare97.conser.nostrategic[,i] > voteshare97.labour.nostrategic[,i]) & (voteshare97.conser.nostrategic[,i] > voteshare97.libdem.nostrategic[,i]) & (voteshare97.conser.nostrategic[,i] < voteshare97.other.nostrategic[,i])) , 1, # other, conser, labour, libdem or other, conser, libdem, labour
 ifelse(
	((voteshare97.labour.nostrategic[,i] < voteshare97.conser.nostrategic[,i]) & (voteshare97.labour.nostrategic[,i] > voteshare97.libdem.nostrategic[,i]) & (voteshare97.labour.nostrategic[,i] > voteshare97.other.nostrategic[,i])) | # conser, labour, libdem, other or conser, labour, other, libdem
	((voteshare97.labour.nostrategic[,i] > voteshare97.conser.nostrategic[,i]) & (voteshare97.labour.nostrategic[,i] < voteshare97.libdem.nostrategic[,i]) & (voteshare97.labour.nostrategic[,i] > voteshare97.other.nostrategic[,i])) | # libdem, labour, conser, other or libdem, labour, other, conser 	
	((voteshare97.labour.nostrategic[,i] > voteshare97.conser.nostrategic[,i]) & (voteshare97.labour.nostrategic[,i] > voteshare97.libdem.nostrategic[,i]) & (voteshare97.labour.nostrategic[,i] < voteshare97.other.nostrategic[,i]))	, 2,  # other, labour, conser, libdem or other, labour, libdem, conser 	
 ifelse(
	((voteshare97.libdem.nostrategic[,i] < voteshare97.conser.nostrategic[,i]) & (voteshare97.libdem.nostrategic[,i] > voteshare97.labour.nostrategic[,i]) & (voteshare97.libdem.nostrategic[,i] > voteshare97.other.nostrategic[,i])) | # conser, libdem, labour, other or conser, libdem, other, labour
	((voteshare97.libdem.nostrategic[,i] > voteshare97.conser.nostrategic[,i]) & (voteshare97.libdem.nostrategic[,i] < voteshare97.labour.nostrategic[,i]) & (voteshare97.libdem.nostrategic[,i] > voteshare97.other.nostrategic[,i])) | # labour, libdem, conser, other or labour, libdem, other, conser	
	((voteshare97.libdem.nostrategic[,i] > voteshare97.conser.nostrategic[,i]) & (voteshare97.libdem.nostrategic[,i] > voteshare97.labour.nostrategic[,i]) & (voteshare97.libdem.nostrategic[,i] < voteshare97.other.nostrategic[,i])) # other, libdem, labour, conser or other, libdem, conser, labour	
	, 3, 6)))
}
...
for (i in 1:N){
	for (j in 1:numsim) {
	if (winner97[i]==1) { net.margin.share[j,i] <- voteshare97.conser.nostrategic[j,i] - max(voteshare97.labour.nostrategic[j,i], voteshare97.libdem.nostrategic[j,i], voteshare97.other.nostrategic[j,i]) }
	else if (winner97[i]==2) { net.margin.share[j,i] <- voteshare97.labour.nostrategic[j,i] - max(voteshare97.conser.nostrategic[j,i], voteshare97.libdem.nostrategic[j,i], voteshare97.other.nostrategic[j,i]) }
	else if (winner97[i]==3) { net.margin.share[j,i] <- voteshare97.libdem.nostrategic[j,i] - max(voteshare97.conser.nostrategic[j,i], voteshare97.labour.nostrategic[j,i], voteshare97.other.nostrategic[j,i]) }
	else net.margin.share[j,i] <- voteshare97.other.nostrategic[j,i] - max(voteshare97.conser.nostrategic[j,i], voteshare97.labour.nostrategic[j,i], voteshare97.libdem.nostrategic[j,i]) 
	}
	net.margin.votes[,i] <- net.margin.share[,i]*spdf.england$totvt97[i]
}
...
net.margin.votes.80lo[i] <- quantile(net.margin.votes[,i], na.rm=T, probs=c(.10))
net.margin.votes.80hi[i] <- quantile(net.margin.votes[,i], na.rm=T, probs=c(.90))
}

# table actual winners vs. predicted winners under non-strategic voting
winner97.nostrategic.modes  <- NULL
for (i in 1:N){
winner97.nostrategic.modes[i] <- as.numeric(names(sort(-table(winner97.nostrategic[,i])))[1])
}
table97 <- table(winner97,winner97.nostrategic.modes)
