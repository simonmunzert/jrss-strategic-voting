...
## Plot voter shifts
pdf(file="../figures/figure2a_strategic_switches_1997.pdf", height=8, width=7, family="URWTimes")
par(mar=c(2,1,6,1))
par(oma=c(1,1,1,0))
par(mfrow=c(3,1))
...
df.b.incent.cola <- df.b.incent.cola[order(df.b.incent.cola[,1], decreasing=F),]
...
title(main="1997", line=-1, cex.main=1.8, outer=T)  
